...
namespace Water2DTool
{
    ...
    public class Water2D_Tool : MonoBehaviour
    {
        ...
        public void UpdateWaterMesh(float wWidth, float wHeight, bool centerPos)
        {
            ...
            if (cubeWater)
                handlesPosition[4] = new Vector3(0, handlesPosition[0].y, zSize);
        ...
        public void SetGPUWaterDefaultMaterial()
        {
            ...
            Material fmMaterial = Resources.Load("Default_LitWaterRippleAdvanced_FM", typeof(Material)) as Material;
            Material tmMaterial = Resources.Load("Default_LitWaterRippleAdvanced_TM", typeof(Material)) as Material;
