...
public class SharkControllerAI : MonoBehaviour
{
    [Space(5)]
    ...
    private float presentPitch = 0f;
    private float presentYaw = 0f;
    private bool isXYalign = false;
    public Vector2 randomValue = Vector2.zero;
    ...
    {
        //sharkAnimStateInfo = sharkAnim.GetCurrentAnimatorStateInfo(0);
        //forward = 1;// Input.GetAxis("Vertical");
    ...
    private void AutoXZalign()
    {
        if (isXYalign)
        {
            ...
            Vector3 xzAlignVector = new Vector3(0, 90 , 0);
    ...
    IEnumerator ChangeDirection()
    {
        ...
        {
            forward = 0.5f;
            randomValue = Vector2.zero;
            switch (Random.Range(0,12))
            {
                case 1: isXYalign = false; randomValue = new Vector2(1, 0); break;
                case 2: isXYalign = false; randomValue = new Vector2(-1, 0); break;
                case 3: isXYalign = false; randomValue = new Vector2(0, 1); break;
                case 4: isXYalign = false; randomValue = new Vector2(0, -1); break;
                case 5: isXYalign = false; randomValue = new Vector2(1, -1); break;
                case 6: isXYalign = false; randomValue = new Vector2(-1, 1); break;
                case 7: isXYalign = false; randomValue = new Vector2(0, 0); break;
                case 8: isXYalign = false; randomValue = new Vector2(-1, 0); break;
                case 9: isXYalign = false; randomValue = new Vector2(-1, 0); break;
                case 10: isXYalign = false; randomValue = new Vector2(-1, 0); break;
                default: isXYalign = true;break;
            }
            isChangeing = true;
        }
    ...
    {
        yaw = Mathf.Clamp(Mathf.Lerp(yaw, randomValue.x, autoPitchRollSpeed) , -1 , 1);
        pitch = Mathf.Clamp(Mathf.Lerp(pitch, randomValue.y, autoPitchRollSpeed), -1, 1);
    }
