...
namespace JiongXiaGu.LowpolyOcean
{
    ...
    public sealed class OceanCameraTask : MonoBehaviour
    {
        ...
        private List<OceanRender> willRenderOceans;
        public IReadOnlyList<OceanRender> WillRenderOceans => willRenderOceans;
        ...
        private void Awake()
        {
            ...
            willRenderOceans = new List<OceanRender>();
        }
        ...
        public void AddWillRenderOcean(OceanRender sender)
        {
            if (sender == null)
        ...
        private void OnPreRender()
        {
            try
            {
                ...
                depthTextureMode |= reflectionHandle.Render(ThisCamera, this, renderContents, TaskController.ReflectionData);
        ...
        /// </summary>
        public void AddUnderUnderOceanMarkDrawer(IObserver<CameraTaskEvent> observer)
        {
            if (observer == null)
        ...
        /// </summary>
        public IDisposable SubscribeUnderOceanMarkDraw(IObserver<CameraTaskEvent> observer)
        {
            if (observer == null)
                throw new ArgumentNullException(nameof(observer));
        ...
        private sealed class ReflectionHandle
        {
            ...
            internal void InternalRender(Camera camera, OceanCameraTask oceanCamera, ReflectionProjectSetting setting, CameraTaskReflectionData reflectionData)
            {
                ...
                {
                    Vector3 pos = reflectionData.Position;
                    Vector3 normal = reflectionData.Normal;
            ...
            public DepthTextureMode Render(Camera camera, OceanCameraTask oceanCamera, PreparedContent renderContents, CameraTaskReflectionData reflectionData)
            {
                var quality = oceanCamera.projectSetting.Reflection;
                if ((renderContents & PreparedContent.ReflectionTexture) != 0)
                {
                    InternalRender(camera, oceanCamera, quality, reflectionData);
                }
                return DepthTextureMode.None;
            }
        }
