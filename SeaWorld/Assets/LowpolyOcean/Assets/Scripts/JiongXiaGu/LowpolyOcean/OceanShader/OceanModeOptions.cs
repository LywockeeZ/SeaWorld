...
namespace JiongXiaGu.LowpolyOcean
{
    ...
    [Serializable]
    [ShaderFieldGroup]
    public sealed class OceanModeOptions
    {
        ...
        public static OceanModeOptions Default => new OceanModeOptions()
        {
        };
        ...
        public OceanModeOptions Clone()
        {
            return (OceanModeOptions)MemberwiseClone();
        }
    }
}
